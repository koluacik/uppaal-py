...
class TestBranchPoint:
    ...
    def test_branchpoint_to_element():
        ...
        xml2 = ET.fromstring('<branchpoint id="id7" x="48" y="-48"></branchpoint>')
        e2 = BranchPoint.from_element(xml2).to_element()
...
class TestLocation:
    ...
    def test_location_init():
        ...
        l3 = Location(
            ...
            pos=(1, 3),
            name=Name("loc1", (4, 8)),
            invariant=Constraint("invariant", "x <= 13", (14, 28)),
        )
        assert l3.id == "id1"
        assert l3.pos == (1, 3)
        assert l3.pos == (1, 3)
    ...
    @staticmethod
    def test_location_from_element():
        """Test the from_element method."""
    ...
    def test_location_get_constrasints():
        ...
        assert len(cs) == 1
        assert cs[0].clocks == ["x"]
        assert cs[0].operator == "<"
        assert cs[0].threshold == 20
        assert cs[0].equality == True
